...
3.点击 组件服务 >> 计算机 >> 我的电脑 >> DCOM配置 >> 找到Microsoft Word
 （注册服务的名字可能不一样，如安装Office 2013之后，注册服务Office Word的名字是 Microsoft Word Explorer 、Office Excel的名字是 Microsoft Excel Application
...
7.在弹出的对话框中添加 ASP.NET、IUSER、IIS_USERS账户
8.点击 "确定" 即可